...
def _argo_rollout_status(k8s, namespace: str, name: str) -> Optional[dict]:
    ...
    try:
        ...
        # Check FailedCreate events first — Gatekeeper denial messages land here
        # and are more specific than the generic Argo Rollout status message.
        msg = ""
        try:
            core = k8s_client.CoreV1Api()
            events = core.list_namespaced_event(namespace, field_selector="reason=FailedCreate")
